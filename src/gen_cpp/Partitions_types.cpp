...
const std::map<int, const char*> _TPartitionType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kTPartitionTypeValues, _kTPartitionTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _TDistributionType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kTDistributionTypeValues, _kTDistributionTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast< ::starrocks::TPrimitiveType::type>(ecast0);
...
bool TPartitionKey::operator==(const TPartitionKey & rhs) const
{
  if (!(sign == rhs.sign))
    return false;
...
bool TPartitionRange::operator==(const TPartitionRange & rhs) const
{
...
bool TRangePartition::operator==(const TRangePartition & rhs) const
{
...
TDataPartition::TDataPartition() noexcept
   : type(static_cast<TPartitionType::type>(0)) {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<TPartitionType::type>(ecast13);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
bool TDataPartition::operator==(const TDataPartition & rhs) const
{
  if (!(type == rhs.type))
    return false;
