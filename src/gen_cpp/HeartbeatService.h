...
class HeartbeatServiceIfSingletonFactory : virtual public HeartbeatServiceIfFactory {
 public:
  ...
  virtual HeartbeatServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(HeartbeatServiceIf* /* handler */) override {}
...
class HeartbeatServiceNull : virtual public HeartbeatServiceIf {
 public:
  ...
  void heartbeat(THeartbeatResult& /* _return */, const TMasterInfo& /* master_info */) override {
    return;
  }
};
...
class HeartbeatService_heartbeat_args {
 public:
  ...
  HeartbeatService_heartbeat_args() noexcept;
...
class HeartbeatService_heartbeat_result {
 public:
  ...
  HeartbeatService_heartbeat_result() noexcept;
...
class HeartbeatServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  HeartbeatServiceProcessorFactory(const ::std::shared_ptr< HeartbeatServiceIfFactory >& handlerFactory) noexcept :
