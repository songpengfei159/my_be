...
const std::map<int, const char*> _TTransactionStatus_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kTTransactionStatusValues, _kTTransactionStatusNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
TStatus::TStatus() noexcept
   : status_code(static_cast< ::starrocks::TStatusCode::type>(0)) {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status_code = static_cast< ::starrocks::TStatusCode::type>(ecast0);
