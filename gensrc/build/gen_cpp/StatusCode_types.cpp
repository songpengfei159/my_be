...
int _kTStatusCodeValues[] = {
  ...
  TStatusCode::YIELD,
  TStatusCode::JIT_COMPILE_ERROR,
  TStatusCode::CAPACITY_LIMIT_EXCEED,
  TStatusCode::BIG_QUERY_CPU_SECOND_LIMIT_EXCEEDED,
  TStatusCode::BIG_QUERY_SCAN_ROWS_LIMIT_EXCEEDED
};
const char* _kTStatusCodeNames[] = {
  ...
  "YIELD",
  "JIT_COMPILE_ERROR",
  "CAPACITY_LIMIT_EXCEED",
  "BIG_QUERY_CPU_SECOND_LIMIT_EXCEEDED",
  "BIG_QUERY_SCAN_ROWS_LIMIT_EXCEEDED"
};
const std::map<int, const char*> _TStatusCode_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(53, _kTStatusCodeValues, _kTStatusCodeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
